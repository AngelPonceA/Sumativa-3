...
export const crearTarjetas = async ( results = [] ) => {
    ...
    results.map((result) => {
        ...
        btnVer.addEventListener("click", () => crearTarjetaUnica (marca, modelo, año, transmision, motor, frenos, velocidades, image, precio, stock));
...
const crearTarjetaUnica = (marca, modelo, año, transmision, motor, frenos, velocidades, image, precio, stock) => {
    ...
    fetch(rutaDocumento)
        ...
        const txtStock = doc.getElementById('Stock');
        txtStock.textContent = `Stock : ${stock} unidades`;
